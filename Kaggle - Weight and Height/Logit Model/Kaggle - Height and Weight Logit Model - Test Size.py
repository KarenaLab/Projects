...
Size_List = np.arange(5, 51, step= 5)

for Size in Size_List:

    print(f" >>> Test Test Size = {Size}%")
...
Title = "Kaggle Height Weight - Logit - Cross Validation - Test Size"
...
plt.axvline(x= 25, color= "black", linestyle= "--", linewidth= 0.5)
