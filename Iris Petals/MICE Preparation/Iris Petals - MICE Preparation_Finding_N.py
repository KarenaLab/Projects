...
for n in range(N_Min, (N_Max+1)):
    ...
    print(f" > Calculating with {n} MICE Neighbours")

    Imputer = IterativeImputer(imputation_order= "ascending", max_iter= 5,
                               n_nearest_features= n, random_state= 42)
...
Title = "Iris Petals - MICE Preparation - Best Neighbours"
